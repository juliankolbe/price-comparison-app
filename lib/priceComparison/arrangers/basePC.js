...
const createDefaultHash = require('../helpers/createDefaultHash')
...
module.exports = ({ masterProductNamesKnex, priceListData, supplierNameIds, supplierProductNameIds }) => {
  ...
  if (!Array.isArray(priceListData)) {
    throw new Error('PriceListData is not an array')
  }
  ...
  // })
  masterHash = createDefaultHash(masterProductNamesKnex, pcConfig.defaultValues, [{recordKey: 'si_no', objectKey: 'id'}, {recordKey: 'product_master_name', objectKey: 'master_product_name'}], 'id')
