...
const DropzoneInput = ({ onFileDropped, name }) => {
  const styles = require('./DropzoneInput.scss')
  return (
    <Dropzone name={name} onDrop={onFileDropped} className={styles.dropzoneInput} activeClassName={styles.dropzoneInputActive}>
      <div className={styles.dropzoneTextDiv}>Drop files here or click in the zone</div>
    </Dropzone>
  )
}
